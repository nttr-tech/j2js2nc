...
import jp.hisano.j2js2nc.CallbackProxy;
import jp.hisano.j2js2nc.CallbackReference;
import jp.hisano.j2js2nc.CallbackThreadInitializer;
...
import jp.hisano.j2js2nc.Memory;
import jp.hisano.j2js2nc.Native;
import jp.hisano.j2js2nc.NativeLibrary;
import jp.hisano.j2js2nc.NativeLong;
import jp.hisano.j2js2nc.NativeMapped;
import jp.hisano.j2js2nc.Platform;
import jp.hisano.j2js2nc.Pointer;
import jp.hisano.j2js2nc.Structure;
import jp.hisano.j2js2nc.ToNativeContext;
import jp.hisano.j2js2nc.TypeConverter;
import jp.hisano.j2js2nc.TypeMapper;
import jp.hisano.j2js2nc.Union;
import jp.hisano.j2js2nc.WString;
import jp.hisano.j2js2nc.Callback.UncaughtExceptionHandler;
import jp.hisano.j2js2nc.CallbacksTest.TestLibrary.CbCallback;
import jp.hisano.j2js2nc.ptr.IntByReference;
import jp.hisano.j2js2nc.ptr.PointerByReference;
import jp.hisano.j2js2nc.win32.DLLCallback;
import jp.hisano.j2js2nc.win32.W32APIOptions;
...
public class CallbacksTest extends TestCase implements Paths {
    ...
    */
    ...
    public void testDLLCallback() throws Exception {
        ...
        final boolean[] called = { false };
        class TestCallback implements TestLibrary.VoidCallback, DLLCallback {
            public void callback() {
                called[0] = true;
            }
        }
